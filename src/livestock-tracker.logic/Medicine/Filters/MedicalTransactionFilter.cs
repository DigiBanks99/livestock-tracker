...
public class MedicalTransactionFilter : IQueryableFilter<MedicalTransaction>
{
    ...
    /// </summary>
    public static MedicalTransactionFilter Null { get; } = new(Array.Empty<long>(), null, false);
    ...
    public void AddAnimalId(long animalId)
    {
        if (this == Null)
        {
            throw new InvalidOperationException("Changes to the Null instance are not permitted.");
        }
