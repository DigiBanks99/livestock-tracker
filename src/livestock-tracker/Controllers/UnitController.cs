...
public class UnitController : LivestockApiController
{
    ...
    {
        string includeDeletedMessage = includeDeleted ? " including deleted items" : string.Empty;
        ...
        IPagedData<IUnit> units = await _unitCrudService
            .FindAsync(filter, u => u.Description, ListSortDirection.Ascending, pagingOptions, RequestAbortToken)
    ...
    public async Task<IActionResult> Get(int id)
    {
        ...
        try
        {
            IUnit? unit = await _unitCrudService.GetOneAsync(id, RequestAbortToken)
                .ConfigureAwait(false);
    ...
    public async Task<IActionResult> Add([FromBody] Unit unit)
    {
        ...
        IUnit addedUnit = await _unitCrudService.AddAsync(unit, RequestAbortToken)
            .ConfigureAwait(false);
    ...
    public async Task<IActionResult> Update(int id, [FromBody] Unit? unit)
    {
        ...
        try
        {
            IUnit updatedUnit = await _unitCrudService.UpdateAsync(unit, RequestAbortToken)
                .ConfigureAwait(false);
    ...
    public async Task<IActionResult> Delete(int id)
    {
        ...
        try
        {
            int removedId = await _unitCrudService.RemoveAsync(id, RequestAbortToken).ConfigureAwait(false);
