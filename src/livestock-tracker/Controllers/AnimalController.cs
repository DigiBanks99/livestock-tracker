...
public class AnimalController : LivestockApiController
{
    ...
    public IActionResult GetAnimals([FromQuery] PagingOptions pagingOptions,
        [FromQuery] OrderingOptions<AnimalOrderType> orderingOptions, bool? includeArchived = false)
    {
    ...
    public async Task<IActionResult> Get([FromRoute] int id)
    {
        ...
        IAnimal? animal = await _animalCrudService.GetOneAsync(id, RequestAbortToken)
    ...
    public async Task<IActionResult> AddAnimal([Required] [FromBody] Animal animal)
    {
        ...
        IAnimal savedAnimal = await _animalCrudService.AddAsync(animal, RequestAbortToken)
            .ConfigureAwait(false);
    ...
    public async Task<IActionResult> UpdateAnimal([FromRoute] int id, [Required] [FromBody] Animal animal)
    {
        ...
        try
        {
            IAnimal savedAnimal = await _animalCrudService.UpdateAsync(animal, RequestAbortToken)
                .ConfigureAwait(false);
