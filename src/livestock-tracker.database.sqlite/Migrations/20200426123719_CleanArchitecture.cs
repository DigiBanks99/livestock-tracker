...
namespace LivestockTracker.Database.Migrations
{
    public partial class CleanArchitecture : Migration
    {
        ...
        {
            migrationBuilder.Sql(sql: "UPDATE FeedingTransactions SET UnitTypeCode = (SELECT TypeCode FROM Unit LIMIT 1) WHERE UnitTypeCode IS NULL;");
            migrationBuilder.Sql(sql: "UPDATE FeedingTransactions SET UnitTypeCode = (SELECT TypeCode FROM Unit LIMIT 1) WHERE UnitTypeCode = 0;");
